...
public class PracticeFormTest extends TestBase {
    ...
    public void practiceFormPositiveTest() {
        new PracticeFormPage(app.driver, app.wait)
                ...
                .uploadPicture("C:\\Users\\EvgenyJava\\Selenium_Tim\\TOOLS\\Acer_Wallpaper_01_5000x2814.jpg")
    ...
    public void practiceFormParameterPositiveTest(String firstName, String lastName, String email, String phone) {
        new PracticeFormPage(app.driver, app.wait)
               ...
               // .uploadPicture("C:\\Users\\PORTISHEAD\\Downloads\\unnamed2.png")
                .uploadPicture("C:\\Users\\EvgenyJava\\Selenium_Tim\\TOOLS\\Acer_Wallpaper_01_5000x2814.jpg")
                // "C:\Users\EvgenyJava\Selenium_Tim\TOOLS\Acer_Wallpaper_01_5000x2814.jpg"
                .enterCurrentAddress("Portishead, Bristol, UK")
                .enterState("NCR")
                .enterCity("Delhi")
                .submitForm()
